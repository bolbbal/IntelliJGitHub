...
public class ScannerWhileEx4 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // 여기서는 시작부터 1 입력 후 상품명을 입력할 때
            // 상품명을 입력하세요: 상품의 가격을 입력하세요: << 이렇게 문자열을 입력받지 않는 오류가 발생함.
            // 풀이를 보니 scanner.nextLine(); 으로 이전에 입력된 개행문자를 제거해야 한다는데 잘 모르겠음..
            // 이전 입력때문에 오류가 난다는게 아직 안받아들여짐
            // 아무튼 코드에 있는 주석처리 풀면 정상작동함..
